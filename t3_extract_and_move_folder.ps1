...
$allSubmissions = Get-ChildItem -Path $downloadsPath | Where-Object Name -like 'Task 3*.tar.gz'
...
$studentSubmissionPath = Join-Path $gradingRootPath "Task3" 'student_submission'
